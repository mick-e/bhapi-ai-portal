...
PLAN_TIERS = {
    ...
    "school": {
        ...
        "stripe_price_monthly": "price_school_v2_monthly",
        "stripe_price_annual": "price_school_v2_annual",
    },
    "school_pilot": {
        "name": "School Pilot",
        "description": "Free 90-day pilot — full School feature parity, up to 50 seats",
        "price_monthly": 0,
        "price_annual": 0,
        "price_unit": "free for 90 days",
        "plan_version": "school_pilot_v1",
        "member_limit": 50,
        "platform_limit": 10,
        "duration_days": 90,
        "auto_convert_to": "school",
        "features": [
            "Everything in School Starter",
            "Free for 90 days, up to 50 seats",
            "Auto-converts to School Starter ($1.99/seat) at end of pilot",
