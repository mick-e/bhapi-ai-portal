...
PLAN_TIERS = {
    ...
    "family_plus": {
        "name": "Bhapi Family+",
        "description": "Every Bhapi feature in one bundle — AI safety, safe social, devices, location, creative, identity protection",
        "price_monthly": 19.99,
        "price_annual": 199.99,
        "member_limit": 8,
        "platform_limit": 10,
        "features": [
            "Everything in Family Plan",
            "Bhapi Social safe network (up to 8 family members)",
            "Device agent (screen time + app monitoring)",
            "Location tracking & geofencing",
            "Creative AI tools (art, stories, stickers)",
            "Intelligence network threat signals",
            "Identity protection partnership",
            "Priority support",
        ],
        "stripe_price_monthly": "price_family_plus_monthly",
        "stripe_price_annual": "price_family_plus_annual",
    },
    "school": {
        "name": "School Starter",
