...
export function RiskScoreSection({ data }: { data: RiskScoreSummary | null }) {
  if (!data) {
    return (
...
export function AIActivitySection({ data }: { data: AIActivitySummary | null }) {
  return (
...
export function SocialActivitySection({ data }: { data: SocialSummary | null }) {
  return (
...
export function ScreenTimeSection({ data }: { data: ScreenTimeSummary | null }) {
  return (
...
export function LocationSection({ data }: { data: LocationSummary | null }) {
  return (
...
export function ActionCenterSection({ data }: { data: ActionCenter | null }) {
  return (
