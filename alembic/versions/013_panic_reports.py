...
def upgrade() -> None:
    if not table_exists("panic_reports"):
        op.create_table(
            "panic_reports",
    ...
    if not index_exists("panic_reports", "ix_panic_reports_group_id"):
        op.create_index("ix_panic_reports_group_id", "panic_reports", ["group_id"])
    if not index_exists("panic_reports", "ix_panic_reports_member_id"):
        op.create_index("ix_panic_reports_member_id", "panic_reports", ["member_id"])
    if not index_exists("panic_reports", "ix_panic_reports_group_created"):
