...
def upgrade() -> None:
    ...
    if not table_exists("time_budgets"):
        op.create_table(
            "time_budgets",
    ...
    if not index_exists("time_budget_usage", "ix_time_budget_usage_group_member_date"):
